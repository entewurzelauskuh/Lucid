...
- **Review flow.** Every change is one pull request for one issue, opened by Claude Code and reviewed and merged by the owner. Claude Code never merges its own work.
